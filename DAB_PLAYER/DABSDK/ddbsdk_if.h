...
#define DDBIF_SUCCEED   0x0 
#define DDBIF_ERROR     -1
...
typedef struct 
{
	...
	DWORD	m_tEntitleTime;										//授权时间，time_t格式。从1970年1月1日0时0分0秒计时
	DWORD	m_tStartTime;										//开始时间，time_t格式。从1970年1月1日0时0分0秒计时
	DWORD	m_tEndTime;											//结束时间，time_t格式。从1970年1月1日0时0分0秒计时
...
void ddbif_versionTest(void);
void ddbif_smgLabReconfig(void);
void ddbif_fileTestReconfig(void);
