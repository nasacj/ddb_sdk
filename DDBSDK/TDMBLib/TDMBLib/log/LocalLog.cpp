...
void WriteLogT(LPSTR lpszFormat, ...)
{
    ...
    sprintf(szDateTime, "[%04d-%02d-%02d %02d:%02d:%02d.%03d]", tm.wYear, tm.wMonth, tm.wDay, tm.wHour, tm.wMinute, tm.wSecond, tm.wMilliseconds);

// 	RETAILMSG(1, (TEXT(szDateTime)));
// 	RETAILMSG(1, (TEXT(szMessage)));
	printf(szDateTime);
	printf(szMessage);
	//printf("\n");
