...
extern "C" DWORD DDBSDK_API DDB_Open(DWORD dwData, DWORD dwAccess, DWORD dwShareMode);
extern "C" BOOL DDBSDK_API DDB_Close(DWORD Handle);
extern "C" BOOL DDBSDK_API DDB_Deinit(DWORD dwContext);
extern "C" DWORD DDBSDK_API DDB_Init(LPCTSTR pContext, DWORD dwBusContext);
extern "C" BOOL DDBSDK_API DDB_IOControl(
										DWORD Handle,
...
#define DDBSDK_MAINPATH_DEFAULT	   "."
