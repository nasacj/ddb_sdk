...
#define DDBSDK_VERSION   0x00010204
...
#define IOCTL_DDBSDK_SUSPEND_ALL_DOWNLOADFILE							CTL_CODE(FILE_DEVICE_DDBSDK, 0x00F4, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_DDBSDK_RESUM_ALL_DOWMLOADFILE								CTL_CODE(FILE_DEVICE_DDBSDK, 0x00F5, METHOD_BUFFERED, FILE_ANY_ACCESS)
